  ...
  return (
    ...
    <div className="container">
      ...
      <div className="doctor1-list">
        ...
        >
          <img 
            src="https://www.fortishealthcare.com/drupal-data/styles/doctor_listing/azblob/doctors/11048.png?itok=qsmz6B2K" 
            alt="Dr. Srinivas Mahesh Prasad" 
            className="doctor1-image" 
          />
          <div className="doctor1-details">
          <h3>
                        Dr. Srinivas Mahesh Prasad</h3>
                    <p><strong>Designation:</strong> 
                        Dr. Srinivas Mahesh Prasad </p>
