  ...
  return (
    ...
    <div className="container">
      ...
      <div className="doctor1-list">
        ...
        >
          <img 
           src="https://www.fortishealthcare.com/drupal-data/styles/doctor_listing/azblob/doctors/3188.png?itok=Q_dcMiHX" 
            alt="Dr. Jayateerth W Kulkarni" 
            className="doctor1-image" 
          />
          <div className="doctor1-details">
          <h3>Dr. Jayateerth W Kulkarni</h3>
                    <p><strong>Designation:</strong> Orthopaedics </p>
