  ...
  return (
    ...
    <div className="container">
      ...
      <div className="doctor1-list">
        ...
        >
          <img 
            src="https://www.fortishealthcare.com/drupal-data/styles/doctor_listing/azblob/doctors/2048.png?itok=Pl_bxaEe"
            alt="Dr. Mahendra Jain" 
            className="doctor1-image" 
          />
          <div className="doctor1-details">
          <h3>Dr. Mahendra Jain</h3>
                    <p><strong>Designation:</strong> Urology  </p>
                    <p><strong>Experience:</strong> 31 Years </p>
          </div>
        </a>
