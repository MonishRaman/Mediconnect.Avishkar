  ...
  return (
    ...
    <div className="container">
      ...
      <div className="doctor1-list">
        ...
        >
          <img 
            src="https://www.fortishealthcare.com/drupal-data/styles/doctor_listing/azblob/doctors/2501.png?itok=e2-rc0dy" 
            alt="Dr. Shivanand S Patil" 
            className="doctor1-image" 
          />
          <div className="doctor1-details">
          <h3>Dr. Shivanand S Patil</h3>
                    <p><strong>Designation:</strong> SENIOR CONSULTANT CARDIOLOGY  </p>
