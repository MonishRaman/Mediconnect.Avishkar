  ...
  return (
    ...
    <div className="container">
      ...
      <div className="doctor1-list">
        ...
        >
          <img 
            src="https://www.fortishealthcare.com/drupal-data/styles/doctor_listing/azblob/doctors/2274.png?itok=gRLLgq8u" 
            alt="Dr. Srinivasa Phanidhar Munigoti" 
            className="doctor1-image" 
          />
          <div className="doctor1-details">
          <h3>Dr. Srinivasa Phanidhar Munigoti</h3>
                    <p><strong>Designation:</strong> CONSULTANT Diabetology </p>
