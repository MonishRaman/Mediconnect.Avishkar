  ...
  return (
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        Welcome to MediConnect, your trusted online healthcare platform. Our mission is to offer accessible and personalized medical services, including consultations, prescriptions, and refills. By using our platform, you agree to adhere to our Privacy Policy and Terms of Service.
        </p>
        ...
        <p className="legal-description">
          When using MediConnect, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          MediConnect is designed to simplify healthcare access. You can choose
