  ...
  return (
    ...
    <div className="container">
      ...
      <div className="doctor1-list">
        ...
        >
          <img 
            src="https://www.fortishealthcare.com/drupal-data/styles/doctor_listing/azblob/doctors/1112.png?itok=bBgElxDD" 
            alt="Dr. Vivek Anand Padegal" 
            className="doctor1-image" 
          />
          <div className="doctor1-details">
          <h3>Dr. Vivek Anand Padegal</h3>
                    <p><strong>Designation:</strong> SENIOR CONSULTANT PULMONOLOGY  </p>
