  ...
  return (
    ...
    <div className="container">
      ...
      <div className="doctor1-list">
        ...
        >
          <img 
            src="https://www.fortishealthcare.com/drupal-data/styles/doctor_listing/azblob/doctors/11636.jpg?itok=CDX6OTWV" 
            alt="Dr. Arvind" 
          ...
          <h3>
                        Dr. Arvind</h3>
                    <p><strong>Designation:</strong> Pediatrics </p>
                    <p><strong>Experience:</strong> 38 Years </p> 
          </div>
        </a>
