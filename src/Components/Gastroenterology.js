  ...
  return (
    ...
    <div className="container">
      ...
      <div className="doctor1-list">
        ...
        >
          <img 
            src="https://www.fortishealthcare.com/drupal-data/styles/doctor_listing/azblob/doctors/8149.png?itok=fWYOnTb6" 
            alt="Dr. Sunil Kasturi" 
            className="doctor1-image" 
          />
          <div className="doctor1-details">
          <h3>Dr. Sunil Kasturi</h3>
                    <p><strong>Designation:</strong> CONSULTANT GASTROENTEROLOGY </p>
                    <p><strong>Experience:</strong> 8Years </p>  
          </div>
        </a>
